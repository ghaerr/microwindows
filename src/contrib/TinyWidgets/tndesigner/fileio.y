...
%token <name> NAME
%token <name> QSTRING
%token WIDGETNAME TYPE PARENT XPOS YPOS HEIGHT WIDTH ENABLED VISIBLE CAPTION EOW CALLBACKCOUNT CALLBACK RESIZE QUOTE QSTRING STRETCH FILENAME HASPIXMAP DEFAULTTEXT ORIENTATION MINVAL MAXVAL PAGESTEP LINESTEP FILLCOLOR FGCOLOR DISCRETE STEPSIZE LABEL CHECKABLE EXCLUSIVE MENUBARYPOS EOL 
