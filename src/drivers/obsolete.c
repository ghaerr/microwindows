/*
 * This file is now the entire contents of libmwdrivers.
 * Do not use libmwdrivers in new code - it is provided only
...
char gr_warning_libmwdrivers_is_obsolete[] =
    "WARNING: libmwdrivers is obsolete and should not be used any more.\n"
