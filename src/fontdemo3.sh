...
#bin/nano-X & bin/nanowm & bin/pcfdemo fonts/pcf/jiskan24.pcf.gz
bin/nano-X & bin/nanowm & bin/pcfdemo /usr/share/fonts/X11/misc/cursor.pcf.gz & bin/pcfdemo fonts/pcf/vga.pcf.gz & bin/pcfdemo fonts/pcf/helvB12_lin.pcf.gz & bin/pcfdemo fonts/pcf/jiskan24.pcf.gz
