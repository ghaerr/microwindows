...
int XOpenIM(int, int, int, int) { DPRINTF("XOpenIM called\n"); return 0; }
int XCloseIM(int) { DPRINTF("XCloseIM called\n"); return 0; }
int XCreateIC(int, int) { DPRINTF("XCreateIC called\n"); return 0; }
...
int XmbResetIC(int) { DPRINTF("XmbResetIC called\n"); return 0; } 
int XGetICValues(int, int) { DPRINTF("XGetICValues called\n"); return 0; } 
...
int XGetErrorText(int, int, int, int) { DPRINTF("XGetErrorText called\n"); return 0; } 
...
int XGrabKeyboard(int, int, int, int, int, int) { DPRINTF("XGrabKeyboard called\n"); return 0; } 
int XGrabPointer(int, int, int, int, int, int, int, int, int) { DPRINTF("XGrabPointer called\n"); return 0; } 
...
int XParseGeometry(int, int, int, int, int) { DPRINTF("XParseGeometry called\n"); return 0; } 
...
int XSendEvent(int, int, int, int, int) { DPRINTF("XSendEvent called\n"); return 0; } 
...
int XSetLocaleModifiers(int) { DPRINTF("XSetLocaleModifiers called\n"); return 0; }
...
int XUngrabKeyboard(int, int) { DPRINTF("XUngrabKeyboard called\n"); return 0; } 
int XUngrabPointer(int, int) { DPRINTF("XUngrabPointer called\n"); return 0; } 
int XUngrabServer() { DPRINTF("XUngrabServer called\n"); return 0; } 
int XVaCreateNestedList(int, int) { DPRINTF("XVaCreateNestedList called\n"); return 0; } 
